        ...
        $(document).ready(function() {
            ...
            if ($('#salesPurchaseChart').length > 0) {
                ...
                function updateTodayOverview(today) {
                    $('#todaySales').text('₹' + parseFloat(today.sales).toLocaleString(undefined, {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2
                    }));
                    $('#todayPurchase').text('₹' + parseFloat(today.purchase).toLocaleString(undefined, {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2
                    }));

                    $('#totalSales').text('₹' + parseFloat(today.total_sales).toLocaleString(undefined, {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2
                    }));
                    $('#totalPurchase').text('₹' + parseFloat(today.total_purchase).toLocaleString(undefined, {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2
                    }));
