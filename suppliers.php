                                ...
                                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger delete-supplier" data-id="<?php echo $row['id']; ?>">
